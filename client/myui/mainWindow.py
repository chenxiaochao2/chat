...
#
# Created: Mon Jun 17 23:06:51 2019
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.members = QtGui.QListWidget(self.centralwidget)
        self.members.setGeometry(QtCore.QRect(670, 340, 151, 201))
...
"font: 75 14pt \"Aharoni\";"))
        ...
        MainWindow.setTabOrder(self.btn_sure, self.members)
        MainWindow.setTabOrder(self.members, self.outputArea)
